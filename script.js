...
const messages = [
    'کسی امروز چیزی برده یا فقط منم که دارم میبازم؟ 😐',
    'سلام رفقا کسی اینجاست؟',
    'من دیشب خوب بودم امروز از همون اول خراب کردم 😂',
    'یکی بگه این دست آخر چی شد',
    'من ۳۰۰ زدم برگشت ۶۰۰، دیگه دست نگه داشتم',
    'داداش من جای تو بودم دیگه ادامه نمیدادم',
    'چرا هرچی میزنم برعکسش درمیاد 😑',
    'امروز اصلا روز من نیست',
    'بچه ها کسی نتیجه این دستو دید؟',
    'من فعلا نشستم نگاه میکنم ببینم چی میشه',
    'یه مقدار بردم، دیگه ریسک نکردم',
    'باز شروع شد 😅',
    'این یکی رو گفتم میبره ولی بازم پرید',
    'کسی موجودیشو زیاد کرده امروز؟',
    'من باخت قبلی رو هنوز جبران نکردم',
    'داداش آروم تر بزن 😂',
    'این دست خیلی عجیب بود',
    'من دیگه برای امروز بستمش',
    'یکی یه تحلیل درست حسابی بگه',
    'چرا انقدر دیر نتیجه میاد؟',
    'بچه ها شما هم همین مشکلو دارید؟',
    'من یه برد کوچیک گرفتم فعلا راضیم ❤️',
    'نه دیگه این یکی واقعا بد بود',
    'یکی بگه چقدر مونده',
    'من گفتم این دست خراب میشه',
    'امروز کلا شانسم خوابیده 😂',
    'یه دست دیگه میزنم بعدش میرم',
    'نه بابا اینجوری که نمیشه',
    'کی گفته این راحت درمیاد؟ 😐',
    'من ۵۰۰ بالا بودم الان برگشتم سر جای اول',
    'یکی جلوی منو بگیره دوباره نزدم 😂',
    'این دست آخر خیلی نزدیک بود',
    'بچه ها کسی برد سنگین کرده امروز؟',
    'من فعلا با مبلغ کم میرم جلو',
    'واسه امروز بسه دیگه',
    'عههههه برد شد 😳',
    'این یکی رو اصلا انتظار نداشتم',
    'من باختم دیگه ادامه نمیدم',
    'خداوکیلی امروز عجیب غریبه'
];
